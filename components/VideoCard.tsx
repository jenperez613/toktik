        ...
        return (
            <div>
                <Link href={`detail/${_id}`}>
                    <video loop src={video.asset.url} className="w-[250px] rounded-xl cursor-pointer"
                    ></video>
                </Link>
            ...
            layout="responsive"/>
                       ...
                       <div>
                           <Link href={`/profile/${postedBy?._id}`}>
                               <div className="flex items-center gap-2">
                                <p className="flex gap-2 items-center md:text-md font-bold text-primary">{postedBy.userName} {` `}
                ...
                <div className="lg:ml-20 flex gap-4 relative">
                    <div onMouseEnter={() => setIsHover(true)}
                        ...
                        <Link href={`/detail/${_id}`}>
                            <video src={video.asset.url} loop ref={videoRef} className="lg:w-[600px] h-[300px] md:h-[400px] lg:h-[530px] w-[200px] rounded-2xl
